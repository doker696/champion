...
function Analysis() {
  ...
  useEffect(() => {
    if (sport) {
      ...
      setData2(
          [
            { name: '2022', value: sport.avg_count_participant_in_year[0] },
            { name: '2021', value: sport.avg_count_participant_in_year[1] },
            { name: '2020', value: sport.avg_count_participant_in_year[2] },
            { name: '2019', value: sport.avg_count_participant_in_year[3] },
            { name: '2018', value: sport.avg_count_participant_in_year[4] },
          ].reverse());
    }
  }, [sport]);
        ...
        <div style={{display: 'flex', flexDirection: 'column', alignContent: 'center', width: '100%',
          ...
          <div className={styles.analPaper}>
            ...
            {isLoading ? (
              ...
              <div className={styles.analGraphs}>
                <div>
                ...
                <div>
                  <div className={styles.analSubTitle}>
                  Среднее количество участников за текущий год:{' '}
                    {sport.avg_participants_last_year}
                  </div>
                  <div className={styles.analSubTitle}>
                    &nbsp;
                  </div>
